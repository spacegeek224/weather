...
Weather.getForecast = function (city, callback) {
  var url = "http://openweathermap.org/data/2.1/forecast/city?q=" + encodeURIComponent(city) + "&cnt=1" + "&appid="+Weather.appid;
...
Weather.getCurrentByCoords = function (lat,lon, callback) {
  var url = "http://openweathermap.org/data/2.1/find/city?lat=" + encodeURIComponent(lat) + "&lon="+encodeURIComponent(lon)+"&cnt=1"+ "&appid="+Weather.appid;
...
Weather.getForecastByCoords = function (lat,lon, callback) {
  var url = "http://openweathermap.org/data/2.1/forecast/city?q=" + encodeURIComponent(city) + "&cnt=1"+ "&appid="+Weather.appid;
